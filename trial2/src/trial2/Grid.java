...
//name frame
   ...
   Icon submitIcon =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\submit.png");
   JButton submitName=new JButton(submitIcon);
   Icon showplayersIcon =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\showplayers.png");
   JButton showplayers=new JButton(showplayersIcon);
   Icon restrarticon =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\restart.png");
   ...
   JButton showmoves=new JButton("moves");
...
public Grid(){
        ...
        add(showmoves);
        showmoves.setLayout(null);
        showmoves.setBounds(50, 700, 200, 100);
        ...
        enter_name.setLocation(400, 50);
        enter_name.setLayout(null);
        enter_name.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        enter_name.setResizable(false);
        enter_name.setContentPane(new JLabel(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\enetrName.png")));
...
public void add_removedSpots_hori(int x,int y){
    if(y>=2&&spots[x][y].c.id==spots[x][y-1].c.id&&spots[x][y-1].c.id==spots[x][y-2].c.id){
         ...
         spots[x][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c666.png"));
         
         spots[x][y-1].c.id=5;
         spots[x][y-1].c.name="Lozenge";
         spots[x][y-1].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c555.png"));
         
         spots[x][y-2].c.id=3;
         spots[x][y-2].c.name="Sausage";
         spots[x][y-2].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c333.png"));                
    }   
}
public void add_removedSpots_hori_super(int x,int y){
    if(y>=3&&spots[x][y].c.id==spots[x][y-1].c.id&&spots[x][y-1].c.id==spots[x][y-2].c.id&&spots[x][y-2].c.id==spots[x][y-3].c.id){
        ...
        spots[x][y].c.id=0;
         ...
         spots[x][y-1].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));
         ...
         spots[x][y-3].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\Supercandy.png")); 
    }   
}
void SuperCandy_active_hori(int x,int y){
         ...
         spots[x][y].c.id=2;
         spots[x][y].c.name=null;
         spots[x][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c222.png"));
         ...
         spots[x][y+3].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c444.png"));
          spots[x][y-1].c.id=6;
         spots[x][y-1].c.name="JUJUBE CLUSTER";
         spots[x][y-1].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c666.png"));
          spots[x][y-2].c.id=1;
         spots[x][y-2].c.name="Sausage";
         spots[x][y-2].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));      
         }
         if(y==1){
             spots[x][y].c.id=2;
         spots[x][y].c.name=null;
         ...
         spots[x][y+4].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c666.png"));
          spots[x][y-1].c.id=1;
         spots[x][y-1].c.name="Sausage";
         spots[x][y-1].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));   
         }
         ...
         spots[x][y+5].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));  
         }
}
//vertically
public void add_removedSpots_ver(int x,int y){
    if(x>=2&&spots[x][y].c.id==spots[x-1][y].c.id&&spots[x-1][y].c.id==spots[x-2][y].c.id){
         ...
         spots[x-1][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c555.png"));
         
         spots[x-2][y].c.id=1;
         spots[x-2][y].c.name="Sausage";
         spots[x-2][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c333.png"));                
    }   
}
public void add_removedSpots_ver_super(int x,int y){
    if(y>=3&&spots[x][y].c.id==spots[x][y-1].c.id&&spots[x][y-1].c.id==spots[x][y-2].c.id&&spots[x][y-2].c.id==spots[x][y-3].c.id){
        ...
        spots[x][y].c.id=0;
         ...
         spots[x-1][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));
         ...
         spots[x-3][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\Supercandy.png")); 
    }   
}
void SuperCandy_active_ver(int x,int y){
         ...
         spots[x-1][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c444.png"));
          spots[x-2][y].c.id=6;
         spots[x-2][y].c.name="JUJUBE CLUSTER";
         spots[x-2][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c666.png"));
          spots[x-3][y].c.id=1;
         spots[x-3][y].c.name="Sausage";
         spots[x-3][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));      
         }
         if(x==4){
             spots[x][y].c.id=2;
         spots[x][y].c.name=null;
         ...
         spots[x-1][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c333.png")); 
         
         spots[x-2][y].c.id=4;
         spots[x-2][y].c.name="GUM SQUARE";
         spots[x-2][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c444.png"));
          spots[x-3][y+4].c.id=6;
         spots[x-3][y].c.name="JUJUBE CLUSTER";
         spots[x-3][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c666.png"));
          spots[x-4][y].c.id=1;
         spots[x-4][y].c.name="Sausage";
         spots[x-4][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));   
         }
         if(x==5){
             spots[x][y].c.id=2;
         spots[x][y].c.name=null;
         ...
         spots[x-3][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c444.png"));
          spots[x-4][y].c.id=6;
         spots[x-4][y].c.name="JUJUBE CLUSTER";
         spots[x-4][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c666.png"));
          spots[x-5][y].c.id=1;
         spots[x-5][y].c.name="Sausage";
         spots[x-5][y].SpotButton.setIcon(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\candies\\c111.png"));  
         }
}
//swap vertically
