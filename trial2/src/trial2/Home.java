...
public class Home extends JFrame implements ActionListener{
    ...
    Icon playIcon =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\playButton.png");
    Icon howtoplay =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\howtoplay.png");
   JButton PlayButton=new JButton(playIcon);
   Icon exitIcon =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\exit.png");
   JButton ExitButton=new JButton(exitIcon);
   JFrame Howtoplay=new JFrame();
   JButton HowtoplayButton=new JButton(howtoplay);
   
   Icon back =new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\back.png");
   ...
   setTitle("Home");
    ...
    setVisible(true);                                            
    setContentPane(new JLabel(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\bg1.jpg")));
    setSize(1000,670);
    add(PlayButton);
    setLayout(null);
   ...
   Howtoplay.setTitle("Game");
    ...
    Howtoplay.setContentPane(new JLabel(new ImageIcon("C:\\Users\\Android-161220\\Desktop\\CANDY java\\attach\\hint2.png")));
